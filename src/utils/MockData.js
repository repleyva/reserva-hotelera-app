...
const mockData = [
  ...
  },
  {
    ...
    price: 140,
    stock: 12,
    notAvailablestart: today.setDate(today.getDate() + 1),
    notAvailableend: today.setDate(today.getDate() + 4),
  },
  {
  ...
  },
  {
    ...
    price: 170,
    stock: 9,
    notAvailablestart: today.setDate(today.getDate() + 8),
    notAvailableend: today.setDate(today.getDate() + 10),
  },
  {
    ...
    price: 175,
    stock: 15,
    notAvailablestart: today.setDate(today.getDate() + 3),
    notAvailableend: today.setDate(today.getDate() + 9),
  },
  {
    ...
    price: 225,
    stock: 10,
    notAvailablestart: today.setDate(today.getDate() + 5),
    notAvailableend: today.setDate(today.getDate() + 11),
  },
  {
    ...
    price: 350,
    stock: 4,
    notAvailablestart: today.setDate(today.getDate() + 10),
    notAvailableend: today.setDate(today.getDate() + 15),
  },
];
